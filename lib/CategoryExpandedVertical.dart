...
class CategoryVertical extends StatelessWidget {
  CategoryVertical({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Row(
            children: [
              ...
              InkWell(
                onTap: (){
                  Navigator.of(context).push(MaterialPageRoute(builder: (_)=>CategoryHorizontal()));
                },
                child: Container(
                  margin: EdgeInsets.only(left: 225, top: 20),
                  child: Image.asset("assets/verticalmenu.png"),
                ),
              ),
            ],
          ),
