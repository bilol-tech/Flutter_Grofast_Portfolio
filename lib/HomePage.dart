...
import 'package:my_first_portfolio/style/style.dart';
                                          ...
                                          children: [
                                              ...
                                              child: Container(
                                                ...
                                                decoration: BoxDecoration(
                                                    ...
                                                    border: isSelect ? Border.all(
                                                        ...
                                                        width: 3) : Border.all(color: Colors.transparent),
                                                    borderRadius:
                                                        BorderRadius.all(
                                                            Radius.circular(30))),
                                                child: Row(
                                            ...
                                            Container(
                                              ...
                                              decoration: BoxDecoration(
                                                ...
                                                gradient: LinearGradient(colors: [Color(0xff26AD71), Color(0xff32CB4B)], begin: Alignment.bottomLeft, end: Alignment.topRight)
                                              ),
                                              child: Center(child: Text("Submit", style: GoogleFonts.montserrat(fontWeight: FontWeight.w700, color: Colors.white, fontSize: 15),)),
                                            ),
                                          ],
                                        ),
                                      );
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child:
                                          Image.asset(listOfPopularImage[index], fit: BoxFit.cover,),
                                    ),
                                    Container(
