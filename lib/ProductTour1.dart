                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Center(child: Text("Fresh groceries to your doorstep!", textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.w700,fontSize: 28, color: Color(0xff194B38)),)),
                    ),
                    Container(
                      width: 280,
                      height: 73,
                      margin: EdgeInsets.only(top: 20),
                      child: Center(child: Text("Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore.", textAlign: TextAlign.center, style: TextStyle(height: 1.6, fontWeight: FontWeight.w500,fontSize: 14, color: Color(0xff9C9C9C)),)),
                    ),
                    GestureDetector(
                      onTap: (){
                        Navigator.of(context).push(MaterialPageRoute(builder: (_)=>ProductTour2()));
                      },
                      child: Container(
                        width: 172,
                        height: 98,
