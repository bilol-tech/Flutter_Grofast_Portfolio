                    ...
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            margin: EdgeInsets.only(left: 160, top: 18),
                                        ...
                                        children: [
                                          ...
                                          Container(
                                              ...
                                              child: GestureDetector(
                                                onTap: (){
                                                  Navigator.of(context).push(MaterialPageRoute(builder: (_)=>ProductPage(image: listOfFruitsImage[index], title: listOfFruitsText[index], star: listOfStar[index], price: listOfPopularPrice[index], starText: listOfStarFruitText[index], iconImage: listOfFruitIcon[index], iconText: listOfFruitIconText[index],)));
                                                },
                                                child: Icon(
                                                  Icons.add,
                                                  color: Colors.white,
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                            ...
                                            child: GestureDetector(
                                              onTap: (){
                                                Navigator.of(context).push(MaterialPageRoute(builder: (_)=>ProductPage(image: listOfVegieImage[index], title: listOfVegieText[index], star: listOfStar[index], price: listOfVegiePrice[index], starText: listOfStarVegieText[index], iconImage: listOfVegieIcon[index], iconText: listOfVegieIconText[index],)));
                                              },
                                              child: Icon(
                                                Icons.add,
                                                color: Colors.white,
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Container(
                                                ...
                                                child: GestureDetector(
                                                  onTap: (){
                                                    Navigator.of(context).push(MaterialPageRoute(builder: (_)=>ProductPage(image: listOfBreadImage[index], title: listOfBreadText[index], star: listOfStar[index], price: listOfBreadPrice[index], starText: listOfStarBreadText[index], iconImage: listOfBreadIcon[index], iconText: listOfBreadIconText[index],)));
                                                  },
                                                  child: Icon(
                                                    Icons.add,
                                                    color: Colors.white,
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                    ...
                                                    child: GestureDetector(
                                                      onTap: (){
                                                        Navigator.of(context).push(MaterialPageRoute(builder: (_)=>ProductPage(image: listOfMeatImage[index], title: listOfMeatText[index], star: listOfStar[index], price: listOfMeatPrice[index], starText: listOfStarMeatText[index], iconImage: listOfMeatIcon[index], iconText: listOfMeatIconText[index],)));
                                                      },
                                                      child: Icon(
                                                        Icons.add,
                                                        color: Colors.white,
